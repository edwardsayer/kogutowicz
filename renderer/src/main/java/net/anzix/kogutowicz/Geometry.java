...
public class Geometry {
     ...
     *                        false otherwise.
     */
    public static boolean isPolylineIntersectingRectangle(double[] x, double[] y,
            double x0, double y0,
            double x1, double y1) {
        if (x.length == 0) {
            return false;
     ...
     */
    public static boolean isRectangleIntersectingRectangle(
            double r1x0, double r1y0,
            double r1x1, double r1y1,
            double r2x0, double r2y0,
            double r2x1, double r2y1) {
        double[] pxs = new double[]{r1x0, r1x1, r1x1, r1x0};
        double[] pys = new double[]{r1y0, r1y0, r1y1, r1y1};
        if (isPolygonIntersectingRectangle(pxs, pys, r2x0, r2y0, r2x1, r2y1)) {
            return true;
        }
        pxs = new double[]{r2x0, r2x1, r2x1, r2x0};
        pys = new double[]{r2y0, r2y0, r2y1, r2y1};
        if (isPolygonIntersectingRectangle(pxs, pys, r1x0, r1y0, r1x1, r1y1)) {
            return true;
        }
        return false;
     ...
     * @return    True if the polyline intersects the rectangle, false otherwise.
     */
    public static boolean isPolygonIntersectingRectangle(double[] x, double[] y,
            double x0, double y0,
            double x1, double y1) {
        int n = x.length;
